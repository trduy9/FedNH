...
class FedNHClient(FedUHClient):
    ...
    def _estimate_prototype(self):
        ...
        # print("to share prototype ne: ", to_share)
        # torch.save(prototype, f"avg_client_proto.pt")
        # # print("prototype client: ", prototype)
        # print("count by class full: ", self.count_by_class_full)
        return to_share
...
class FedNHServer(FedUHServer):
    ...
    def aggregate(self, client_uploads, round):
        ...
        with torch.no_grad():
            ...
            # print("server avg prototype: ", avg_prototype)
            ...
            # print("server model state dict: ", self.server_model_state_dict)
